...
public class CalendarService {
    ...
    public static void readCalendar(Context context, int days, int hours) {
		...
		*/
        ...
        for (String id : calendarIds) {
            ...
            Log.d("Event Count", "eventCursor count="+eventCursor.getCount());
            ...
            if(eventCursor.getCount()>0)
            {
                ...
                Log.d("EventMap", eventMap.keySet().size() + " " + eventMap.values());
    ...
    public static CalendarEvent loadEvent(Cursor csr) {
        ...
        try
        {
            ...
            if(cursor.getCount() > 0)
            {
                ...
                while (cursor.moveToNext()) {
                    ...
                    Log.d("CalendarService()", "Id: " + _id + " Display Name: " + displayName + " Selected: " + selected);
                    calendarIds.add(_id);
